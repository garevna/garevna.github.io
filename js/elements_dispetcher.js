...
( function __init () {
	...
	_normal = { width: 100, height: 100, top: 0, left: 0, rotX:0, rotY:0, rotZ:0 };
	current = { width: 100, height: 100, top: 0, left: 0, rotX:0, rotY:0, rotZ:0 };
	target = { width: 100, height: 100, top: 0, left: 0, rotX:0, rotY:0, rotZ:0 };
	distance = { width: 0, height: 0, top: 0, left: 0, rotX:0, rotY:0, rotZ:0 };
	steps = { width: 0, height: 0, top: 0, left: 0, rotX:0, rotY:0, rotZ:0 };
	worker_num = 0;
	sourseURL = '';
	sourse_content = '';
	blocked = false;
...
var types = [ 'init', 'target', 'win_resize', 'normal', 'wide', 'rotate' ];
