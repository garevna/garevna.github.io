...
var garevna_html_07 = function (func_name) {
	...
	var func = {};
		...
		func['visibility'] = function() {
			...
			document.getElementsByClassName("browser_win").item(0).style.height = window.innerHeight * 0.7 + 'px';
		};
		// ---------------------------------------------------------------------------------------------- overflow
		...
		func['margin_padding'] = function(ref) {
			...
			html += '<div class="browser_win">';
			html += '<div id="outer-block">Внешний блок<div id="inner-block">Внутренний блок</div></div></div>';
			garevna_Level2.scene.innerHTML = html;
			var obj = [ 
		...
		func['display_values'] = function(ref) {
			...
			html += '<!-- Демо работы атрибута dispalay --><div>';
			garevna_Level2.scene.innerHTML = html;
			document.getElementsByClassName("browser_win").item(0).style.height = window.innerHeight * 0.7 + 'px';
			// ================================================================================================
